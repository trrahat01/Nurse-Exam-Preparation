-- ============================================================
-- FINAL FIX - Run this FIRST, then run seed-mcqs.sql
-- This creates the exact schema that seed-mcqs.sql expects
-- ============================================================

-- Drop and recreate questions table to match seed-mcqs.sql format
...
-- RLS: Allow public read and anon insert
